export const responseMessage = {
    ...
    websiteNotExist: `Website does not exist!`,
    ...
    dataAlreadyUploaded: (message: string): string => { return `This${message} is already uploaded!` },
    ...
    getDataNotFound: (message: string): string => { return `We couldn't find the ${message.toLowerCase()} you requested!` },
    updateDataSuccess: (message: string): string => { return `${message[0].toUpperCase() + message.slice(1).toLowerCase()} has been successfully updated!` },
